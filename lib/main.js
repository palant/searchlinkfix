...
new WindowObserver({
  applyToWindow: function(window)
  {
    ...
    window.gBrowser.addEventListener("click", interceptClick, true);
  ...
  removeFromWindow: function(window)
  {
    ...
    window.gBrowser.removeEventListener("click", interceptClick, true);
...
function interceptClick(event)
{
  ...
  if (link && /^\s*https?:/i.test(link.getAttribute("href")) && isSearchPage(link.ownerDocument.defaultView))
